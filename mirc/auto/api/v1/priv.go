...
type Priv interface {
	...
	UpdateTweet(*web.UpdateTweetReq) (*web.UpdateTweetResp, mir.Error)
...
func (UnimplementedPrivServant) UpdateTweet(req *web.UpdateTweetReq) (*web.UpdateTweetResp, mir.Error) {
	return nil, mir.Errorln(http.StatusNotImplemented, http.StatusText(http.StatusNotImplemented))
}
